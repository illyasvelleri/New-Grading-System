                                ...
                                {viewMode === 'day' ? (
                                    <div className="flex gap-3 flex-wrap">
                                        <button
                                            ...
                                            className={`flex-1 px-4 py-2 rounded-lg text-sm font-medium shadow-md transition ${attendanceData[student._id] === 'present'
                                        ...
                                        <button
                                            ...
                                            className={`flex-1 px-4 py-2 rounded-lg text-sm font-medium shadow-md transition ${attendanceData[student._id] === 'absent'
